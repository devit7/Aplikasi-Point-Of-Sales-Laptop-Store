    ...
    <div class="p-7">
        ...
        <div class="mt-10 flex justify-between w-full mx-auto rounded-md">
            <div class="w-[600px] flex flex-col gap-4">
                <p class="rounded-md p-4 font-semibold bg-[#1C1D42] text-[#6b6eb4]">Input New Merk</p>
                <div class="rounded-md p-4 bg-[#1C1D42] text-[#6b6eb4]">
                    <form action="{{ route('merk.store') }}" method="POST">
                        @csrf
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            <div class="sm:col-span-2">
                                <label for="payment_name" class="block mb-2 text-sm font-medium text-gray-400">Merk Name</label>
                                <input type="text" name="payment_name" id="payment_name"
                                    ...
                                    placeholder="Ex: Victus" required>
                            </div>
                            <div class="sm:col-span-2">
