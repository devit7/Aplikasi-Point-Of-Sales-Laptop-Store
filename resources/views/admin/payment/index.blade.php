    ...
    <div class="p-7">
        <div class="mb-6 flex items-end justify-between">
            ...
            <div class="flex flex-row">
                ...
                sclass="flex flex-row items-center gap-2 px-4 py-2 bg-[#FF9A37] text-white rounded-md hover:bg-[#FF9A37]">
                    ...
                    <table class="w-full mt-2" id="table">
                        <thead class="bg-[#131432] text-[#6b6eb4]">
                            <tr class="border-b-2 border-[#33356F]">
                                ...
                                <th class="text-[#6b6eb4]">Payment Name</th>
                                ...
                                <tr class="border-b-2 border-[#33356F]">
                                    ...
                                    <td class="flex justify-center gap-2">
                                        ...
                                        <form action="{{ route('payment.destroy', $payment->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this payment method?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="bg-[#002D4C] border p-1 border-[#2B4F69] rounded-md">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
