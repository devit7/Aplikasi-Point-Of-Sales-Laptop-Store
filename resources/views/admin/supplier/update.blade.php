                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        <div class="sm:col-span-2">
                            <label for="supplier_name" class="block mb-2 text-sm font-medium  text-white">Supplier
                                Name</label>
                            <input value="{{ $data['supplier_name'] }}" type="text" name="supplier_name"
                                id="supplier_name"
                        ...
                        <div class="w-full">
                            ...
                            <input value="{{ $data['no_hp'] }}" type="tel" name="no_hp" id="no_hp"
                                class="bg-[#131432] border   text-sm rounded-lg  block w-full p-2.5  border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500"
                        ...
                        <div class="w-full">
                            ...
                            <input value="{{ $data['nama_perusahaan'] }}" type="text" name="nama_perusahaan"
                                id="nama_perusahaan"
                                class="bg-[#131432] border   text-sm rounded-lg  block w-full p-2.5  border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="alamat" id="alamat" rows="8"
                                ...
                                placeholder="Alamat supplier">{{ $data['alamat'] }}</textarea>
                            @error('alamat')
                                <p id="outlined_error_help" class="mt-2 text-xs text-red-700">
                                    {{ $message }}
                                </p>
