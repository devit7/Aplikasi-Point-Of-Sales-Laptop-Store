...
@section('content')
    <div class="p-3">
        <div class="flex justify-end p-8">
            <a href="{{ route('supplier.create') }}" class="px-3 md:px-4 py-1 md:py-2 bg-[#aa5800] text-white rounded-lg hover:bg-[#aa5800]">
                <i class="fa-solid fa-arrow-right-to-bracket"></i> Add Supplier
            </a>
        </div>
