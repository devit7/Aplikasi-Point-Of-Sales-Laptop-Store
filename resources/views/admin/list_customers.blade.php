            ...
            <div class="w-full mx-auto mt-2 bg-[#1C1D42] text-[#6b6eb4] p-4 rounded-md">
                <table class="w-full mt-2" id="table">
                    ...
                    <tbody class="bg-[#1C1D42]">
                        @php
                            $customers = [
                                ['no' => 1, 'name' => 'John Doe', 'email' => 'john@example.com', 'phone' => '123-456-7890', 'address' => '123 Main St, City, Country'],
                                ['no' => 2, 'name' => 'Devit', 'email' => 'devitgaming@yahoo.com', 'phone' => '999-999-999', 'address' => 'Surabaya, Sidoarjo'],
                                ['no' => 3, 'name' => 'Porque', 'email' => 'porque@gmail.com', 'phone' => '122-635-65345', 'address' => 'Loindorlt'],
                            ];
                        @endphp
