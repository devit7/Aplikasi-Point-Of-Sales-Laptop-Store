                ...
                <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                    ...
                    <form action="#">
                        <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                            ...
                            <div>
                                <label for="category" class="block mb-2 text-sm font-medium  text-white">Merk</label>
                        ...
                        <div class="sm:col-span-2">
                            <div class=" mt-3 relative border border-gray-400 border-dashed rounded-lg p-6" id="dropzone">
