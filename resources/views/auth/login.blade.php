...
<body class="bg-[#131432] flex justify-center place-items-center h-screen">
    ...
    <!-- <div class=" flex flex-row">
        ...
        <form action="" class=" flex flex-col justify-center place-items-center gap-y-6 bg-[#1C1D42] p-4 w-96 rounded-xl">
            ...
            <button
            class=" bg-indigo-900 border-2 border-indigo-500 rounded-lg shadow text-center text-indigo-500 text-base font-semibold px-16 py-2 mt-1
                hover:bg-indigo-500 hover:text-indigo-900" type="submit">Login now</button>
        </form>
    </div> -->
</body>
</html>
