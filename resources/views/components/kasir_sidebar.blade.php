    ...
    <div class="relative flex flex-col  bg-[#131432]   h-full w-full  ">
        <nav class="flex flex-col  w-[280px] font-sans text-base font-normal text-[#62748E]">
            ...
            <div class="flex flex-col py-6 px-5 gap-1 font-semibold">
                ...
                <a href="user-management" tabindex="0"
                    class="flex items-center w-full  px-6 py-3 rounded-lg text-start leading-tight transition-all hover:bg-[#aa5800] hover:bg-opacity-10 hover:text-[#e07946] outline-none
                ">
                    <div class="grid place-items-center mr-3">
                ...
                <p class="text-gray-400 text-sm font-bold  tracking-wider py-4">
                    INVENTORY
                </p>
                <a href="/admin/pesanan" tabindex="0"
                    class=" flex items-center w-full  px-6 py-3 rounded-lg text-start leading-tight transition-all hover:bg-[#aa5800] hover:bg-opacity-10 hover:text-[#e07946] outline-none
                ">
                    <div class="grid place-items-center mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    ...
                    <div class="grid place-items-center ml-auto justify-self-end">
                        <div class="relative grid items-center font-sans font-bold uppercase whitespace-nowrap select-none bg-[#aa5800] bg-opacity-10 text-[#e07946] py-1 px-2 text-xs rounded-full"
                            style="opacity: 1;">
                            <span class="">14</span>
                        </div>
                    </div>
