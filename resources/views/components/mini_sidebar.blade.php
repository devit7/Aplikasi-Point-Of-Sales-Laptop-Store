<section id="sidebar" class="top-0 left-0 bottom-0 hidden lg:block border-r border-[#33356F] ">
    <div class="relative flex flex-col bg-[#131432] h-full w-full ">
        <nav id="lebar-sidebar" class="flex flex-col w-[280px] font-sans text-base font-normal text-[#62748E]">
            <div class="h-[80px] text-center items-center flex justify-center border-b border-[#33356F]">
                <h1 id="sidebar-toggle" class="font-semibold cursor-pointer text-3xl text-gray-500">POS</h1>
            </div>
            <div class="flex flex-col py-6 px-5 gap-1 font-semibold">
                <p class="text-gray-400 text-sm font-bold  tracking-wider pb-4">
                    MAIN
                </p>
                <a href="/admin" tabindex="0" id="ic-dashboard"
                    ...
                    <span id="tk-dashboard">Dashboard</span>
                </a>
                <div class="flex flex-col  font-semibold ">
                    <button type="button" id="ic_management"
                        ...
                        {{-- <span id="tk_management" class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Management</span> --}}
                ...
                <a href="/admin/customer" tabindex="0"
                    class=" flex items-center w-full px-4 py-3 rounded-lg text-start leading-tight transition-all hover:bg-[#aa5800] hover:bg-opacity-10 hover:text-[#e07946] outline-none
