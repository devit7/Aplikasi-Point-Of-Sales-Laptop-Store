    ...
    <div>
        <div class="relative flex flex-col bg-[#131432] h-full w-full ">
            ...
            <div class="flex flex-col py-6 px-5 gap-1 font-semibold">
                <p class="text-gray-400 text-sm font-bold tracking-wider pb-4">MAIN</p>
                <a href="/admin" tabindex="0" class="flex items-center w-full px-6 py-3 rounded-lg text-start leading-tight transition-all hover:bg-[#aa5800] hover:bg-opacity-10 hover:text-[#e07946] outline-none bg-[#aa5800] bg-opacity-10 text-[#e07946] ">
                ...
                <div class="flex flex-col gap-0 font-semibold ">
                    <button type="button" class="flex items-center py-3 px-6 w-full text-start outline-none rounded-lg leading-tight transition-all hover:bg-[#aa5800] hover:bg-opacity-10 hover:text-[#e07946]" aria-controls="dropdown-example" data-collapse-toggle="dropdown-example">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                    ...
                    <ul id="dropdown-example" class="hidden py-2 space-y-2">
                        ...
                        <li>
                            <a href="#" class="flex items-center w-full px-6 py-3 rounded-lg text-start leading-tight transition-all hover:bg-[#aa5800] hover:bg-opacity-10 hover:text-[#e07946] outline-none pl-11">Supplier</a>
                        </li>
                        <li>
                ...
                <div class="py-2 ">
                    <hr class=" border-[#33356f]"></div>
                <p class="text-gray-400 text-sm font-bold tracking-wider py-4">OTHER</p>
                <a href="/admin/pesanan" tabindex="0" class=" flex items-center w-full px-6 py-3 rounded-lg text-start leading-tight transition-all hover:bg-[#aa5800] hover:bg-opacity-10 hover:text-[#e07946] outline-none">
                <div class="grid place-items-center mr-3">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <div role="button" tabindex="0" class="flex items-center w-full px-6 py-3 rounded-lg text-start leading-tight transition-all hover:bg-[#aa5800] hover:bg-opacity-10 hover:text-[#e07946] outline-none">
                    <div class="grid place-items-center mr-3">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewbox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
