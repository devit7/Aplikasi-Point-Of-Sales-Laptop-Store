            ...
            <form action="" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="email" id="email" class="bg-[#131432] border   text-sm rounded-lg  block w-full p-2.5  border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500" placeholder="" required="">
                    </div>
                    <div class="w-full">
                        <label for="no_hp" class="block mb-2 text-sm font-medium  text-white">Phone number</label>
                        <input type="number" name="no_hp" id="no_hp" class="bg-[#131432] border   text-sm rounded-lg  block w-full p-2.5  border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500" placeholder="" required="">
                    </div>
                    <div class="sm:col-span-2">
