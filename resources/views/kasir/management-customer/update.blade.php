        ...
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="customer_name" id="customer_name" value="{{ $customer['customer_name'] }}" class="bg-[#131432] border text-sm rounded-lg  block w-full p-2.5  border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="w-full">
                    <label for="email" class="block mb-2 text-sm font-medium  text-white">Email</label>
                    <input type="text" name="email" id="email" value="{{ $customer['email'] }}" class="bg-[#131432] border text-sm rounded-lg  block w-full p-2.5  border-gray-600 placeholder-gray-400 text-white focus:ring-primary-500 focus:border-primary-500" placeholder="" required="">
                </div>
                <div class="w-full">
