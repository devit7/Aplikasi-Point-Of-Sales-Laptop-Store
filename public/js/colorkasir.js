...
linkElements.forEach(link => {
    ...
    if (linkMerkId === merkId) {
        link.classList.add('bg-[#fa9e3b]', 'bg-opacity-10', 'text-[#e07946]');
        ...
        allElement.classList.add('bg-[#fa9e3b]', 'bg-opacity-10', 'text-[#e07946]');
        allElement.classList.remove('bg-[#151e3b ]', 'hover:bg-[#fa9e3b]', 'hover:bg-opacity-10',
            'hover:text-[#e07946]');
    } else {
        link.classList.remove('bg-[#fa9e3b]', 'bg-opacity-10', 'text-[#e07946]');
